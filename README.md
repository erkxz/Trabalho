...
1. *"Converta o sistema de terminal para Streamlit mantendo as funções CRUD e a persistência em JSON"*
2. *"Organize a interface em abas, uma para cada operação do sistema"*
3. *"Substitua os inputs do terminal por campos de formulário no Streamlit"*
4. *"Adicione validações de campos e mensagens de feedback para o usuário"*
5. *"Remova os comentários do código final"*
